...
<html lang="es">
    ...
    <body>
        ...
        <div style="margin:20px 0 40px 0">
            <a style="margin-right:20px; color:#0B5407; font-weight:bold;" href="../modulo.disenia.producto/consultar.php">CONSULTAR</a>
            <a style="margin-right:20px; color:#0B5407;" href="../modulo.disenia.producto/insertar.php">INSERTAR</a>
            <a style="margin-right:20px; color:#0B5407;" href="../modulo.disenia.producto/eliminar.php">ELIMINAR</a>
        </div>
