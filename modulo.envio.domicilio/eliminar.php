...
<html lang="es">
    ...
    <body>
        ...
        <div style="margin:20px 0 40px 0">
            ...
            <a style="color:#0B5407; font-weight:bold;" href="../modulo.envio.domicilio/eliminar.php">ELIMINAR</a>
        </div>
        ...
        if (isset($_POST['txtid'])) {
            ...
            if ($stmt->rowCount() > 0) {
                ...
                echo 'ERROR: No se logro eliminar (asegurese de haber ingresado un Id)';
            }
        }
        ?>
