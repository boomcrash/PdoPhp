...
<html lang="es">
    ...
    <body>
        ...
        <div style="margin:20px 0 40px 0">
            ...
            <a style="margin-right:20px; color:#0B5407; font-weight:bold;" href="../modulo.resenias/insertar.php">INSERTAR</a>
            <a style="color:#0B5407;"href="../modulo.resenias/eliminar.php">ELIMINAR</a>
        </div>
